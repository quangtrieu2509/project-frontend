import { CalendarOutlined, CheckOutlined, CloseOutlined, HeartFilled, UserAddOutlined } from "@ant-design/icons"
...
export const notiIcons: Item = {
  ...
  'booking': <CalendarOutlined className="text-lg text-blue-800"/>
} 
